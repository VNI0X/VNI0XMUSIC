...
from VNI0XMUSIC import Carbon, app
from VNI0XMUSIC.utils.decorators.language import language, languageCB
from VNI0XMUSIC.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from VNI0XMUSIC.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from VNI0XMUSIC import YouTube
...
@app.on_callback_query(filters.regex("VNI0X_playlist") & ~BANNED_USERS)
@languageCB
